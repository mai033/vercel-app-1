...
import { FaArrowRight } from 'react-icons/fa';
import { useNavigate } from 'react-router-dom';
import { uploadToVercelBlob } from '../../utils/uploadToVercelBlob'; // Make sure this path is correct
...
const PDFUpload = () => {
  ...
  const handleFileChange = async (
    ...
    try {
      // Use uploadToVercelBlob here
      await uploadToVercelBlob(selectedFile, setFilePreview, 'pdfUrl');
      setUploadSuccess(true);

      // Display PDF file name instead of preview
